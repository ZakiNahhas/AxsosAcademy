class BankAccount {
    ...
    public void withdrawMoney(String type, double depMoney) {
        if (type == "checking") {
            if (totalMoney >= depMoney) {
                double moneyWithdrawn1 = getCheckingBalance() - depMoney;
                totalMoney -= depMoney;
        ...
        if (type == "savings") {
            if (totalMoney >= depMoney) {
                ...
                double moneyWihdrawn2 = getSavingsBalance() - depMoney;
                totalMoney -= depMoney;
                System.out.println("Your remaining money: $" + totalMoney);
            } else {
                System.out.println("insufficient funds");
